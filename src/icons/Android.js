...
function SvgAndroidBrands(props) {
  return (
    <svg
      aria-hidden="true"
      data-prefix="fab"
      data-icon="android"
      className="android-brands_svg__svg-inline--fa android-brands_svg__fa-android android-brands_svg__fa-w-18"
      viewBox="0 0 576 512"
      {...props}
    >
      <path
...
export default SvgAndroidBrands;
